...
unset($__errorArgs, $__bag); ?>"  name="title" name="title" value="<?php echo e(old('title')); ?>"   autofocus>                            
                            </div>
...
unset($__errorArgs, $__bag); ?>" name="description" value="<?php echo e(old('description')); ?>"  autocomplete="description"></textarea>                             
                            </div>
